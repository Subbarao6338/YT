...
localStorage.setItem("skipSilence","false");
localStorage.setItem("audioBoost","false");
...
var audioCtx, source, gainNode, analyser, bufferLength, dataArray;
...
function processAudio() {
    ...
    if (localStorage.getItem("audioBoost") == "true") {
        gainNode.gain.value = 3.0; // 300% boost
    } else {
        gainNode.gain.value = 1.0;
    }

    if (localStorage.getItem("skipSilence") == "true") {
        ...
        if (average < 5 && !video.paused && !video.seeking) { // Threshold for silence
...
<br>
<div>Audio Boost <span data-action="sttCnf" data-value="audioBoost" style="${sttCnf(0,0,"audioBoost")}" ><b style="${sttCnf(0,1,"audioBoost")}" ></b></span></div>
<br>
...
if(localStorage.getItem("skipSilence") == "true" || localStorage.getItem("audioBoost") == "true"){
    initAudioPipeline();
}
